<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-title v-if="value._links">
            Subscription # {{decode(value._links.self.href.split("/")[value._links.self.href.split("/").length - 1])}}
        </v-card-title >
        <v-card-title v-else>
            Subscription
        </v-card-title >        
        ...
        <v-card-text>
            <Number v-if="editMode" label="SubId" v-model="value.subId" :editMode="editMode" :inputUI="''"/>
